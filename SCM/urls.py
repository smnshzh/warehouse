...
urlpatterns = [
    ...
    path ('warehouse-invoice', views.make_warehouse_invoice, name="make_warehouse_invoice"),
    path ('report/sended-orders-report', views.sell_sended_order_report, name="sell_sended_order_report"),
    path ('ready-acoounting-shipments', views.show_shipments_ready_for_accounting,
